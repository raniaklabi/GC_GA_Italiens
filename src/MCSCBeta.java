...
public class MCSCBeta {
	...
	public static void main(String[] args) throws IOException {
		...
		/*File fichier = new File("C:\\Users\\rania\\Desktop\\Thèse\\Projects\\GC_GA_Italiens\\resultMCSCBeta.txt");
		...
		//}	 
			 ...
			 try {
				 File file = new File("C:\\Users\\rania\\Desktop\\Thèse\\Projects\\GC_GA_Italiens\\resultMCSCBeta.dat");
				 if (!file.exists()) {
				        file.createNewFile();
				    }
