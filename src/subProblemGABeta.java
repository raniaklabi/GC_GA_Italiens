...
public class subProblemGABeta {
	...
	public double chromosome(int n, int m,int [][]delta,double Talpha,List<Edge>  edges,double []pi,double [][]SPL,Graph graph,List<Edge>  undirectededges,int [][]link,double []fi,double betha) {
    	...
    	/*System.out.print("\n************************sizepop= "+sizep);
    	int ag2=sc.nextInt();*/
    	pop.calculeFitnessPopulationBeta(pi, fi, delta, m, betha);
    	...
    	while((itr<MaxIT)&&(dup<maxDup)) {
        	...
        	int ag2=sc.nextInt();*/
    		C.CalculeFitnessBeta(pi, fi, delta, m, betha);
    ...
    /*	System.out.println("");
    	...
    	bestSolution.CalculeFitnessBeta(pi, fi, delta, m, betha);
