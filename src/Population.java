...
public void InitializePopulation1(double Talpha,int n,int m,Graph graph,double [][]SPL,double []pi,int [][]delta,List<Edge> edges, List<Edge> undirectededges,int [][]link) {
	...
	public Individu connectFeasibiltyOperator(Individu ind,int n,int m,Graph graph,double [][]SPL,double []pi,List<Edge> edges,List<Edge> subEdges,int [][]link,int rand) {
...
public Individu coverFeasibilityOperator(Individu ind,int n,int m,double Talpha,int [][]delta,double []pi,int rand) {
	Individu coverInd=ind;
	List<Integer> coveredTarget= new ArrayList<Integer>();
