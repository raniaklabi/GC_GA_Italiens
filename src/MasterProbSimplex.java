...
public class MasterProbSimplex {
    ...
    public MasterProbSimplex(double[][] A, double[] b, double[] c) {
        M = b.length;
        N = c.length;
   ...
   // index of a non-basic column with most positive cost
    ...
    public void master(int N,int M,int K, double [][]A,int [][]bb,double []b,double []c,double betha) { 
        test(A, b, c);
    }
