...
public class HCGBeta {

	public static void main(String[] args) throws IOException {
		Scanner sc= new Scanner(System.in);
		File fichier = new File("C:\\Users\\rania\\Desktop\\Thèse\\Projects\\GC_GA_Italiens\\resultHCGBeta.dat");
    	...
    	coverSets.pop.calculeFitnessPopulationBeta(pi, fi, delta, m, betha);*/
    	bestLifetime=0;
    	MasterProbBeta mb;
    	subProblemGABeta sph;
    	 int occ=0;
			 while((r>0)) {
    			...
    			System.out.println(" lifetime="+bestLifetime);
			...
			// ag2=sc.nextInt();
			 pw.append(bestLifetime+" ;");
		}
		pw.append(" AverageL="+(averageLifetime/5)+"execution time: "+(averageTime/1000)/5+" seconde"+"number CS="+averageCS/5+"min: "+minLifetime+"max: "+maxLifetime);
		pw.newLine();	
		pw.close();
